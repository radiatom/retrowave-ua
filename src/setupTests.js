...
function getUniqueObjects(array1, array2) {
      ...
      // // Додаємо об'єкти з першого масиву, які не мають однакового значення в другому масиві
      // for (const obj of array1) {
      //     if (!array2.some(item => item.title === obj.title)) {
  ...
  const uniqueObjects = getUniqueObjects(data, tracks1);
